...
ModelRegex = re.compile(r'Model: \S*')
...
list_of_model = ModelRegex.findall(Content)
...
usedModel = clean_data(list_of_model, r'Model: \S*')
...
print("Model: %s" % os.path.basename(usedModel[10::]))
...
with open(dirPath, mode='w') as extract_file:
	...
	extract_writer.writerow(["Model", os.path.basename(usedModel[10::])])
